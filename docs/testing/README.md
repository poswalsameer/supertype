...
| **Phase 4** | [`phase-4.md`](./phase-4.md) | Catalog (4 models, quantization, license), verified downloader, Parakeet + Whisper same trait, hardware rec, privacy, dictionary, LLM extension |
